    ...
    return (
        <nav className="flex justify-between items-end px-2 bg-white xs:px-5 sm:px-10 lg:px-12 py-4 fixed left-0 top-0 w-full z-20 dark:bg-black dark:text-white border border-[#ffffff25]">
            ...
            <div className="flex-2 flex gap-2 fold:gap-4 2xs:gap-6 xs:gap-12">
                ...
                <Link href='#experience' className="text-[0.9rem] font-medium hidden hover:font-bold transition transition-all duration-200 2xs:text-[0.9rem] xs:text-[1rem] md:block">Experience</Link>
                ...
                <Link href='#contact' className="text-[0.9rem] font-medium hover:font-bold transition transition-all duration-200 2xs:text-[0.9rem] xs:text-[1rem]">Contact</Link>
            </div>
        </nav>
    )
}
