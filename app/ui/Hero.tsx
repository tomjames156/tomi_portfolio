    ...
    return (
        <section className='flex justify-center h-screen pt-60' id='hero'>
            <div className='max-w-[45%] flex-col text-center'>
                ...
                <p className={`mt-4 leading-[1.4rem] text-[1.1rem] ${libre_franklin.className} antialiased`}>I’m a budding data scientist and and software engineering student from Abuja, Nigeria. I’m passionate about building innovative software based solutions to real-world problems.</p>
