    ...
    return (
        <section className='flex justify-center pt-60 pb-20 lg:pb-60' id='hero'>
            <div className='flex-col text-center max-w-[85%] sm:max-w-[80%] md:max-w-[70%] lg:max-w-[60%] xl:max-w[45%]'>
                ...
                <h1 className='text-2xl mt-10 font-bold sm:text-4xl'>Hi there, I’m Tomisin</h1>
                <h3 className='text-xl mt-1 font-medium sm:text-2xl sm:mt-4'>I love writing code</h3>
                <p className={`mt-1 leading-[1.2rem] text-[0.9rem] ${libre_franklin.className} antialiased sm:mt-4 sm:text-[1.1rem] sm:leading-[1.4rem]`}>I’m a budding data scientist and and software engineering student from Abuja, Nigeria. I’m passionate about finding actionable insights from data and building innovative solutions to real-world problems.</p>
