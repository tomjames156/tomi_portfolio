    ...
    return (
        <section className='flex justify-center pt-60 pb-20 lg:pb-60' id='hero'>
            <div className='flex-col text-center max-w-[85%] sm:max-w-[80%] md:max-w-[70%] lg:max-w-[45%] '>
                ...
                <h1 className='text-2xl mt-10 font-bold xs:text-3xl sm:text-4xl'>Hi there, I’m Tomisin</h1>
                <h3 className='text-xl mt-1 font-medium xs:text-[1.3rem] sm:text-2xl sm:mt-4'>I love writing code</h3>
                <p className={`mt-1 leading-[1.2rem] text-[0.9rem] ${libre_franklin.className} antialiased xs:text-[1.1rem] xs:leading-[1.3rem] xs:mt-2 sm:mt-4 sm:text-[1.1rem] sm:leading-[1.4rem]`}>I’m a budding data scientist and and software engineering student from Abuja, Nigeria. I’m passionate about finding actionable insights from data and building innovative solutions to real-world problems.</p>
                <Link href="/resume.pdf" target='_blank' download={true} title="Download Resume" className='w-fit mt-10 mx-auto flex border-[0.1rem] border-blue-900 text-center align-center text-blue-900 pl-2 pr-4 py-0.5 rounded-md gap-[0.25rem] transition-all ease-in-out duration-100 hover:bg-blue-900 hover:text-white hover:border-[0.15rem] text-[0.9rem] sm:[text-1rem]'>
